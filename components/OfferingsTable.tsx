      ...
      <table className="text-sm" style={{ minWidth: '750px', width: '100%' }}>
        <thead>
          <tr style={{ background: 'var(--bg-sub)', borderBottom: '1px solid var(--border)' }}>
            {columns.map((col, i) => (
              <th key={i} className="text-left px-4 py-3 font-semibold" style={{ color: 'var(--text-muted)' }}>
                {col}
              </th>
            ))}
            ...
            filtered.map((o) => {
              ...
              return (
                <Fragment key={o.offering_version_id}>
                  <tr
                    onClick={() => toggle(o.offering_version_id)}
                    style={{
                  ...
                  >
                    ...
                    <td className="px-4 py-3" style={{ color: 'var(--text-muted)' }}>
                      {o.number_enrolled ?? 0}/{o.available_places ?? '∞'}
                    </td>
                    ...
                    <td
                      ...
                      style={{ position: 'sticky', right: 0, background: isOpen ? 'var(--bg-sub)' : 'var(--bg-sidebar)' }}
                    >
                      <ChevronDown
                        size={16}
                        style={{
