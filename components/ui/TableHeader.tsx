      ...
      <div className="flex items-center gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => toggle(favKey === 'students' ? 1 : 2)} className="hover:opacity-70 transition"
              title={pinned ? 'Remove from dashboard' : 'Pin to dashboard'}>
              <Star size={18} style={{ color: pinned ? '#f59e0b' : 'var(--text-muted)', fill: pinned ? '#f59e0b' : 'none', transition: 'all 0.2s' }} />
            </button>
